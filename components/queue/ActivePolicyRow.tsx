...
export function ActivePolicyRow({ policy }: { policy: ActivePolicy }) {
  ...
  return (
    <div className="flex flex-col gap-2 rounded-xl border border-black/5 dark:border-white/10 bg-black/[0.02] dark:bg-white/[0.08] backdrop-blur-xl shadow-sm p-4">
